...
import SimilarAndRecommendations from "../components/Similar&Recommendations";
  ...
  return (
    <div className="w-full h-full">
      ...
      <section className="w-full my-6 px-6 lg:px-[18%]">
        ...
        <SimilarAndRecommendations id={id} cat="similar" />
      </section>
      <section className="w-full my-6 px-6 lg:px-[18%]">
        <h2 className="lg:text-2xl font-semibold text-white">
          Recommendations
        ...
        <SimilarAndRecommendations id={id} cat="recommendations" />
      </section>
    </div>
  );
};
